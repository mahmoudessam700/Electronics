          ...
          <div className="flex items-center justify-between h-[60px]">
            ...
            <div className="flex-1 max-w-[800px] mx-4">
              <div className="flex items-center">
                <select className="h-10 px-2 bg-[#F3F3F3] border-none rounded-l-md text-[#0F1111] text-sm focus:outline-none focus:ring-2 focus:ring-[#718096]">
                  <option>All</option>
                ...
                <Button 
                  ...
                  className="h-10 bg-[#718096] hover:bg-[#4A5568] text-white rounded-r-md rounded-l-none px-4"
                >
