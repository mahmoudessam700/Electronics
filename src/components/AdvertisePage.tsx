...
export function AdvertisePage({ onNavigate: _onNavigate }: AdvertisePageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#EAEDED]">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-[#7c3aed] to-[#a855f7] text-orange-600 py-20">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="hidden md:block">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-white/20">
                ...
                <h3 className="text-2xl mb-2 text-orange-600">{t('advertise.reachYourCustomers')}</h3>
